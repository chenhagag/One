...
- **Insights are written by Claude agent** — NOT auto-generated by GPT. The completion pipeline skips insights. Claude reads full conversations + traits and writes insights during daily pipeline runs. See `Docs/insights-writing-guide.md` for style rules.
