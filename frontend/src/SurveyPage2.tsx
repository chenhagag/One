...
const QUESTIONS_PART2: SurveyQuestion[] = [
  ...
  },
  {
    ...
    smallSubtitle: "מה גורם לך לחשוב שיש פה משהו ששווה להמשיך איתו? שOne מחפשת אקטיבית עבורך, התובנות, כרטיס ההתאמה, הדיוק בהתאמות — או אולי משהו אחר שלא חשבנו עליו.",
    type: "open",
  },
];
