...
const DEMO_MATCH_WW: MatchCardData = {
  person1: { name: "גל", photo: "/demo/gaya.png" },
  person2: { name: "גאיה", photo: "/demo/womenExample.png" },
  introSummary: `גאיה עובדת כמתכנתת, למדה פסיכולוגיה ואף חלמה על קלינית ילדים — ומתגעגעת לזה. יש לה עין חדה לאנשים, היא שקטה מבחוץ אבל שנונה ועמוקה מבפנים, ואוהבת שיחות ארוכות על אוכל טוב.

גל מלמדת עברית באולפן ומייעצת בתחום ה-EdTech. גם היא למדה פסיכולוגיה, אוהבת שפות ושיחות עומק, ומאמינה שנחמדות היא תכונה שלא מעריכים מספיק.

שתיכן חולקות עולם מקצועי-אקדמי דומה, גישה דומה לחיים, וסוג של שיחה שיש סיכוי טוב שתרגיש טבעית כבר מההתחלה.`,
  connectionPoints: [
    {
      title: "שפה משותפת",
      text: "לשתיכן תואר בפסיכולוגיה, וזה לא סתם פרט ברזומה — זה אומר שיש לכן שפה משותפת של הסתכלות על אנשים, על מערכות יחסים ועל העולם. גאיה אוהבת לנתח אנשים בשקט, גל מתחברת לכל מה שנוגע בחוויה האנושית. זו נקודת פתיחה שלא צריך לבנות — היא כבר שם.",
    },
    {
      title: "ערכים שמסתנכרנים",
      text: "שתיכן חילוניות עם עמדה ברורה, מאמינות בחופש בחירה ובפתיחות מחשבתית, ומסתייגות מדוגמות. שתיכן מעדיפות חיים של איכות — מסעדות, שיחות עמוקות, זמן משמעותי עם אנשים שחשובים לכן — על פני הרדיפה אחרי \"עוד\". הערכים האלה הם הבסיס שעליו נבנית זוגיות יציבה לאורך זמן.",
    },
    {
      title: "אינטימיות שקטה",
      text: "שתיכן לא מחפשות רעש. גאיה מעדיפה מעט אנשים קרובים על פני מעגלים רחבים, וגל מתארת בדיוק את אותו דבר — שתי חברות נפש, ורצון לקשרים עם עומק אמיתי. יש כאן פוטנציאל לזוגיות שבה שני הצדדים מבינים את הצורך של השנייה במרחב, בשקט ובקשר שלא דורש הוכחות חיצוניות.",
    },
    {
      title: "סגנון תקשורת תואם",
      text: "שתיכן מעדיפות לעבד דברים בפנים לפני שמדברות, לא אוהבות דרמות, ושואפות לפתור דברים בשיחה ענייניית ומכבדת. הגישה הזו — רוגע עם כנות — נחשבת לאחד הסימנים המשמעותיים לפוטנציאל של זוגיות בריאה לטווח ארוך.",
    },
  ],
  dateIdea: "במקרה שלכן, המפגש הראשון לא צריך להיות \"אטרקציה\". דווקא ערב פשוט, במסעדה טובה ושקטה, יכול לאפשר למה שמעניין בהתאמה הזו לצאת החוצה: שיחה חכמה שזורמת מנושא לנושא, סקרנות הדדית, והנאה מאוכל טוב.\n\nכדאי לבחור מקום שמאפשר נוכחות — לא רועש מדי, לא פורמלי מדי — ולתת לשיחה להתפתח בלי למהר לסמן אם \"כן\" או \"לא\". לפעמים התאמות מהסוג הזה נפתחות לא דרך ניצוץ מיידי, אלא דרך תחושה שמי שמולך מבינה את השפה שלך.",
  caveat: "שתיכן מתארות את עצמכן כאנשים שנוטים לפאסיביות — גאיה נמנעת מקונפליקטים ומעבדת דברים בפנים, וגל מזהה את אותו דפוס אצל עצמה. זה לא בהכרח פער בעייתי — אבל זו נקודה שכדאי לשים אליה לב כבר בהתחלה.\n\nהאתגר הוא לא להיכנס למצב שבו שתיכן מחכות שהצד השני תיזום, תפתח נושא, או תגיד מה מפריע. אם תצליחו לדבר על זה בגלוי — ואפילו לצחוק על זה ביחד — יכול להיווצר כאן קשר שמאפשר לשתיכן להרגיש בטוחות מספיק כדי להגיד את מה שבאמת עובר עליכן.",
  closing: "אנחנו מאמינות בהתאמה הזו כי מצאנו חיבור שהוא לא רק \"על הנייר\" — אלא דפוס עמוק של ערכים משותפים, סגנון תקשורת תואם, ועולם פנימי שמדבר את אותה שפה. זה לא קורה בכל יום.\n\nמאחר ואנחנו שומרות על הפרטיות של שתיכן, לא ניתן לחשוף כאן את כל מה שעומד מאחורי ההתאמה הזו — אבל יש עוד הרבה רבדים שגילינו, ואנחנו מקוות שתגלו אותם יחד.",
};
