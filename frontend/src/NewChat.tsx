    ...
    <div id="nc-root" style={styles.container}>
      ...
      <div className={`nc-sidebar${menuOpen ? " open" : ""}`} style={styles.sidebar}>
        ...
        <div style={styles.sidebarItems}>
          ...
          {/* Match card — shown when user has an active match */}
          {activeMatchCard && (
            <button
              style={(screen === "match_card" || screen === "match_chat") ? styles.sidebarItemActive : styles.sidebarItem}
              onClick={() => {
            ...
            <div style={{ padding: "4px 20px 10px", textAlign: "center", direction: "rtl" }}>
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 18 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 4, cursor: "pointer" }} onClick={() => setScreen("bug_report")}>
                  ...
                  <span style={{ fontSize: 11, color: "#999" }}>משוב</span>
                </div>
                <a href="https://wa.me/972549037400" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: 4, textDecoration: "none" }}>
                  ...
                  <span style={{ fontSize: 11, color: "#999" }}>ווטסאפ</span>
                </a>
                <a href="mailto:one-support@googlegroups.com" style={{ display: "flex", alignItems: "center", gap: 4, textDecoration: "none" }}>
                  <span style={{ fontSize: 16 }}>✉️</span>
                  <span style={{ fontSize: 11, color: "#999" }}>מייל</span>
                </a>
              </div>
            </div>
          );
