...
const BIG_FIVE_RELATIONSHIP: Record<string, { high: string; low: string }> = {
  ...
  neuroticism: {
    high: "רגישות רגשית גבוהה — מודעות עמוקה לרגשות, חווה דברים בעוצמה. בזוגיות, הרגישות הזו היא כוח — היא מאפשרת חיבור רגשי עמוק ואמפתיה. חשוב לבנות תקשורת פתוחה עם בן/בת הזוג ולמצוא דרכים משותפות לווסת רגעי מתח.",
    low: "רגישות רגשית נמוכה — יציב רגשית, מתמודד עם לחצים ברוגע. בזוגיות זה מביא עוגן ויציבות, אבל חשוב לא לזלזל ברגשות של בן/בת הזוג שעשויים לחוות דברים בעוצמה גדולה יותר.",
  },
};
