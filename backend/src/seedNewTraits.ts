...
const NEW_TRAITS: NewTrait[] = [
  ...
  { internal_name: "analytical_reasoning", display_name_he: "חשיבה אנליטית", display_name_en: "Analytical Reasoning", ai_description: "Analytical Reasoning should be based on evidence of structured reasoning: breaking down situations into components, explaining cause and effect, identifying mechanisms or underlying structure. Do NOT base this trait on: general clarity, emotional understanding, social reasoning, politeness or balanced answers.", trait_group: "Cognitive Profile", sensitivity: "normal", calc_type: "normal" },
  ...
  { internal_name: "conceptual_precision", display_name_he: "בהירות מושגית", display_name_en: "Conceptual Precision", ai_description: null, trait_group: "Cognitive Profile", sensitivity: "normal", calc_type: "normal" },
  { internal_name: "verbal_articulation", display_name_he: "יכולת ניסוח", display_name_en: "Verbal Articulation", ai_description: null, trait_group: "Cognitive Profile", sensitivity: "normal", calc_type: "normal" },
  ...
  { internal_name: "social_intuitive_intelligence", display_name_he: "אינטיליגנציה חברתית-אינטואיטיבית", display_name_en: "Social Intuitive Intelligence", ai_description: null, trait_group: "Cognitive Profile", sensitivity: "normal", calc_type: "normal" },
