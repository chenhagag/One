...
const TRAIT_TO_TOPIC: Record<string, string> = {
  analytical_reasoning: "analytical thinking / structured reasoning",
  abstract_thinking: "abstract thinking / conceptual reasoning",
  cognitive_flexibility: "mental flexibility / adapting to new ideas",
  conceptual_precision: "conceptual clarity / precision of thought",
  verbal_articulation: "verbal expression / articulation ability",
  social_intuitive_intelligence: "social intelligence / reading people intuitively",
