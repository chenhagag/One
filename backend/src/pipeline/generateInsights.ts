...
"summary_short" — 2-3 משפטים שנותנים תמונה כללית ומדויקת של מי ${youWord}: מה הדפוס המרכזי שלך, מה מניע אותך, ומה סוג ${partnerType} הזוג שיתאים לך. זה לא ציטוט של פסקה אחת מתוך הניתוח המלא — זו שורה תחתונה שמסכמת את כל התמונה בקצרה, בפנייה ישירה ל${genderWord} בגוף שני.

"summary_full" — 7-10 פסקאות ניתוח מפורט. כל פסקה 2-4 משפטים. הפרד בין פסקאות עם שורה ריקה (\\n\\n). עדיף פסקה קצרה ומדויקת מפסקה ארוכה שממחזרת רעיון.
