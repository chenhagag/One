...
"summary_short" — 2-3 משפטים. פותח בתובנה על מי ${youWord} ומה מאפיין אותך, ואז מה סוג ${partnerType} הזוג שיתאים לך. לא גנרי — ספציפי ומדויק.

"summary_full" — 7-10 פסקאות. כל פסקה 2-4 משפטים. עדיף פסקה קצרה ומדויקת מפסקה ארוכה שממחזרת רעיון.
