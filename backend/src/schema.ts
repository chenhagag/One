...
export function createSchema(db: Database.Database) {
  ...
  const migrations: [string, string, string][] = [
    ...
    ["conversation_messages", "guide", "ALTER TABLE conversation_messages ADD COLUMN guide TEXT"],
  ...
  db.transaction(() => {
    ...
    const cityData: [string, string][] = [
      ...
      ["הוד השרון", "מרכז-שרון"], ["נתניה", "מרכז-שרון"], ["רמת השרון", "מרכז-שרון"],
      ["ראשון לציון", "מרכז-שפלה"], ["רחובות", "מרכז-שפלה"], ["נס ציונה", "מרכז-שפלה"],
      ["לוד", "מרכז-שפלה"], ["רמלה", "מרכז-שפלה"], ["מודיעין", "מרכז-שפלה"],
      ["פתח תקווה", "מרכז-שפלה"], ["יבנה", "מרכז-שפלה"], ["אריאל", "מרכז-שפלה"],
      ["ירושלים", "ירושלים"], ["מבשרת ציון", "ירושלים"], ["בית שמש", "ירושלים"],
      ["חיפה", "צפון"], ["קריות", "צפון"], ["עכו", "צפון"],
      ["נהריה", "צפון"], ["נצרת", "צפון"], ["טבריה", "צפון"],
      ["כרמיאל", "צפון"], ["עפולה", "צפון"], ["צפת", "צפון"],
      ["באר שבע", "דרום"], ["אשדוד", "דרום"], ["אשקלון", "דרום"],
      ["אילת", "דרום"], ["דימונה", "דרום"],
    ];
