...
const BIG_FIVE_INFO: Record<string, { he: string; desc: string; relationship: string }> = {
  ...
  neuroticism: { he: "עוצמת תגובה רגשית", desc: "עוצמת התגובה הרגשית, מודעות פנימית ורגישות לשינויים ולחצים", relationship: "חשוב בן/בת זוג שמבין את הצרכים הרגשיים ויודע לספק ביטחון ורוגע" },
};
